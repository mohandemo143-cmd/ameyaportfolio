...
const fields = [
  ...
  { n: "budget", l: "Budget Range", t: "text" },
];
      ...
      <div className="mx-auto grid max-w-6xl gap-16 md:grid-cols-2">
        <div>
          ...
          <h2 className="mt-3 text-balance text-4xl font-medium leading-tight md:text-5xl">
            Tell us what you're{" "}
            <em className="font-display italic text-secondary">
              building
            </em>
            .
          </h2>
          ...
          <p className="mt-6 max-w-md text-foreground/60">
            We reply within one business day. For urgent engagements, mention it
            in your message and we'll prioritize.
          </p>
